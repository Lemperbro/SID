...
@section('container')
    <div class="px-4 sm:container h-screen">
        ...
        <form action="/login" method="POST"
            class="shadow-xl rounded-lg px-4 py-10 max-w-xl absolute left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] w-full ">
            @csrf


            <h1 class="font-semibold text-center text-2xl mb-4">Login</h1>
            ...
            <div class="mt-5">
                ...
                <input type="email" id="email" name="email"
                    class="mt-2 w-full rounded-md bg-gray-200 p-2 border-none focus:outline-main4 focus:outline-1 focus:ring-0"
            ...
            <button type="submit"
                class="text-white bg-main p-2 rounded-md font-semibold text-center block w-full mt-10">Login</button>

            @if ($hitungUser < 1)
                <p class="text-center my-2 text-gray-500">Belum punya akun ?</p>
                <a href="/register"
                    class="text-white bg-orange-600 p-2 rounded-md font-semibold text-center block w-full ">Register</a>
        </form>
        @endif
    </div>
@endsection
