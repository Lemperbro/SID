...
@section('container')
    <div class="pt-24 pb-20">
        ...
        <form action="/admin/program-kerja/tambah-data" method="POST" id="my-dropzone" enctype="multipart/form-data"
            ...
            <div class="flex items-center   rounded mt-4 ">
                <input id="bordered-checkbox-1" type="checkbox" value="program unggulan" name="programUnggulan"
                    class="p-2 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
