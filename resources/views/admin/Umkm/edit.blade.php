...
@section('container')
    <div class="pt-24 pb-20">
        ...
        <div class="my-32">
            <img src="{{ asset('FtUmkm/'.$data->image) }}" alt="" id="previewImage" class="mx-auto w-[300px] h-[200px] object-cover">
        </div>

        <form action="/admin/umkm/edit/{{ $data->slug }}" method="POST" id="my-dropzone" enctype="multipart/form-data" class=" max-w-6xl mx-auto">
            @csrf
            <div class="w-full">
                <label for="image"
