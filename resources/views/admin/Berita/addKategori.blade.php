...
<div class="pt-24 pb-20">
    <h1 class="text-gray-900 dark:text-white font-semibold text-xl">Kategori - Tambah Kategori</h1>

    <form action="/admin/kategori-berita/add" method="POST" class="max-w-6xl mx-auto mt-20">
        @csrf
        <div>
